...
namespace OriNoco
{
  internal class HistoryBuffer
    : IOriNocoPoolable<HistoryBuffer>
  {
    #region Interface
    IOriNocoPool<HistoryBuffer> IOriNocoPoolable<HistoryBuffer>.Pool { get; set; }
    void IOriNocoPoolable<HistoryBuffer>.Reset() { this.Reset(); }
    #endregion
